const destinations = [
  { id: 'amalfi', name: 'Amalfi Coast', location: 'Italy', type: 'coast', label: 'Sun-soaked', description: 'Lemon groves, sea swims, and long lunches.', duration: '3 days', budget: '$$$', best: 'May–September', highlights: ['Ravello gardens', 'Sunset boat ride', 'Lemon granita'], image: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&w=800&q=82' },
  { id: 'copenhagen', name: 'Copenhagen', location: 'Denmark', type: 'city', label: 'Design-forward', description: 'Bikes, bakeries, and very good people watching.', duration: '2 days', budget: '$$', best: 'April–October', highlights: ['Canal-side cycling', 'Nørrebro bakeries', 'Louisiana Museum'], image: 'https://images.unsplash.com/photo-1513622470522-26c3c8a854bc?auto=format&fit=crop&w=800&q=82' },
  { id: 'azores', name: 'São Miguel', location: 'Azores', type: 'nature', label: 'Wild & green', description: 'Volcanic lakes and hot springs under open skies.', duration: '3 days', budget: '$$', best: 'June–October', highlights: ['Sete Cidades lake', 'Furnas hot springs', 'Ponta Delgada'], image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=800&q=82' },
  { id: 'kyoto', name: 'Kyoto', location: 'Japan', type: 'city', label: 'Quietly magical', description: 'Temple walks, tiny bars, and gardens in bloom.', duration: '3 days', budget: '$$$', best: 'March–May', highlights: ['Fushimi Inari dawn', 'Gion backstreets', 'Tea house afternoon'], image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=800&q=82' },
  { id: 'mallorca', name: 'Mallorca', location: 'Spain', type: 'coast', label: 'Blue hour', description: 'Mountain roads that end at a perfect cove.', duration: '3 days', budget: '$$', best: 'May–October', highlights: ['Deià swim', 'Tramuntana drive', 'Palma old town'], image: 'https://images.unsplash.com/photo-1530789253388-582c481c54b0?auto=format&fit=crop&w=800&q=82' },
  { id: 'lake-bled', name: 'Lake Bled', location: 'Slovenia', type: 'nature', label: 'Storybook', description: 'Alpine air, still water, and a tiny island.', duration: '2 days', budget: '$', best: 'May–October', highlights: ['Lake loop walk', 'Island boat ride', 'Vintgar Gorge'], image: 'https://images.unsplash.com/photo-1530789253388-582c481c54b0?auto=format&fit=crop&w=800&q=82' },
  { id: 'lisbon', name: 'Lisbon', location: 'Portugal', type: 'city', label: 'Golden & easy', description: 'Tile-lined streets, custard tarts, late sunsets.', duration: '2 days', budget: '$$', best: 'All year', highlights: ['Tram 28 ride', 'Alfama sunset', 'Pastéis de nata'], image: 'https://images.unsplash.com/photo-1555881400-74d7acaacd8b?auto=format&fit=crop&w=800&q=82' },
  { id: 'scotland', name: 'The Highlands', location: 'Scotland', type: 'nature', label: 'Big skies', description: 'Misty lochs and a cabin with no notifications.', duration: '3 days', budget: '$$', best: 'April–September', highlights: ['Loch Ness drive', 'Glen Coe hike', 'Cabin fire'], image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=800&q=82' }
];
...
function renderDestinations() {
  ...
  grid.innerHTML = filtered.map((destination) => `
    <article class="destination-card">
      ...
      <h3>${destination.name}</h3><p>${destination.description}</p><button class="guide-link" data-guide="${destination.id}" type="button">View mini guide <span>↗</span></button>
    </article>`).join('');
...
function openDetail(id) {
  ...
  document.querySelector('#detailFacts').innerHTML = `<span><b>${destination.duration}</b> trip length</span><span><b>${destination.budget}</b> spend level</span><span><b>${destination.best}</b> best time</span>`;
